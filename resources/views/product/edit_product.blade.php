                                    ...
                                    @method('PUT')
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="2" name="details" type="text">{{$product->details}}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Status</label>
                                            <select id="select" class="form-control" name="status" type="text"  value="{{$product->status}}">
